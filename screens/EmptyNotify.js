	...
	return (
		<View style={styles.nearby_job_container}>
			<View style={{ alignItems: "center", justifyContent: "center" }}>
				<Image source={{uri : notifies.imageCompany}} style={styles.logo} />
			</View>
			<View style={styles.textContainer}>
				<Text>{notifies.notifyString} {notifies.jobName}</Text>
				<Text style={styles.location}>From company: {notifies.companyName}</Text>
